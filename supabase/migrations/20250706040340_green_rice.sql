/*
  # Fix Subscription Plans and Pricing
  
  1. Ensure Subscription Plans Table
    - Create subscription_plans table if it doesn't exist
    - Add is_coming_soon column
    - Set correct pricing for all plans
  
  2. Update Plan Details
    - Professional plan price: $19.99/month (fixed from $9.99)
    - Enterprise plan: $99/user/month (marked as "Coming Soon")
    - Standard plan: $9.99/month
    - Free plan: $0
  
  3. Ensure Proper RLS Policies
    - Public read access to subscription plans
    - User-specific access to subscriptions
*/
