/*
  ...
  1. Updates
    - Set Standard plan as most popular (was Professional)
    - Ensure all plans have correct pricing
    - Fix plan descriptions and features
    - Ensure Enterprise plan is marked as coming soon
  
  2. Pricing
    - Explorer (Free): $0
    - Standard: $9.99/month (MOST POPULAR)
