...
('standard', 'Standard', 'Great for regular users', 9.99, 'month',
 '["Everything in Explorer", "Save up to 25 notebooks", "Submit unlimited notebooks", "Advanced search features", "Email notifications", "Basic analytics"]',
 '{"savedNotebooks": 25, "submittedNotebooks": -1, "premiumContent": false, "popular": true}',
 true, false),
