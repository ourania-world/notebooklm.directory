/*
  ...
  1. User Profiles Table
    - Links to auth.users for user information
    - Stores additional profile data

  2. Saved Notebooks Table
    - Allows users to save/bookmark notebooks
    - Many-to-many relationship between users and notebooks

  3. Update Notebooks Table
    - Add user_id to link notebooks to their creators
