/*
  # Fix Subscription Plans - Make Standard Most Popular
  
  1. Updates
    - Set Standard plan as the most popular option
    - Ensure Professional plan is $19.99/month
...
('free', 'Explorer', 'Sustainable Discovery for All', 0.00, null, 
 ...
 '{"savedNotebooks": 5, "submittedNotebooks": 2, "premiumContent": false, "popular": false}',
 true, false),
