/*
  # Update Subscription Plans - Unlimited Submissions for All
  
  1. Changes
    - All plans now allow unlimited notebook submissions
    - Standard plan now allows unlimited saved notebooks (was 25)
    - Simplified plan descriptions
    - Removed environmental messaging
    - Clarified features
