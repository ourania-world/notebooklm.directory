...
// Ensure we're using the correct Supabase URL and key
const finalSupabaseUrl = supabaseUrl.includes('ciwlmdnmnsymiwmschej') 
  ? supabaseUrl 
  : 'https://ciwlmdnmnsymiwmschej.supabase.co';

const finalSupabaseKey = supabaseAnonKey.includes('ciwlmdnmnsymiwmschej') 
  ? supabaseAnonKey 
  : 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImNpd2xtZG5tbnN5bWl3bXNjaGVqIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NTE2OTQzNjMsImV4cCI6MjA2NzI3MDM2M30.Ri_L-EBOOIvTY3WnMd91oegjauObj76pS4JmVIr4yjw';
